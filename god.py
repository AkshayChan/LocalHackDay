...
def classify(bot, update, emo, bud):
	...
	if (emotion == "happiness"):
		...
		finaltext = "Your reccomended drink is " + happyChoice[0] + ". The cost of a standard drink is £" + happyChoice[1] + "."
	...
	#NEUTRAL
		...
		finaltext = "Your reccomended drink is " + neutralChoice[0] + ". The cost of a standard drink is £" + neutralChoice[1] + "."
		bot.sendMessage(chat_id=update.message.chat_id, text=finaltext)
	...
	#ANGER
		...
		finaltext = "Your reccomended drink is " + angerChoice[0] + ". The cost of a standard drink is £" + angerChoice[1] + "."
		bot.sendMessage(chat_id=update.message.chat_id, text=finaltext)
	...
	#SADNESS
		...
		finaltext = "Your reccomended drink is " + sadnessChoice[0] + ". The cost of a standard drink is £" + sadnessChoice[1] + "."
		bot.sendMessage(chat_id=update.message.chat_id, text=finaltext)
